...
contract GauntletGasAnalysisTest is TestBase {
    ...
    function testShuffleGasConsumption() public {
        ...
        console2.log("Gas for tryStartGauntlet (includes selection + VRF request):", 
            gasBeforeShuffle - gasAfterStart);
    }
    ...
    function testWorstCaseGauntletScenario() public {
        ...
        if (totalEstimated > blockGasLimit) {
            ...
            console2.log("OK Worst case still within limits, remaining:", 
                blockGasLimit - totalEstimated);
        }
    }
}