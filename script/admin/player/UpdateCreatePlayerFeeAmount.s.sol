...
contract UpdateCreatePlayerFeeAmountScript is Script {
    ...
    function run(address payable playerContractAddr, uint256 newCreatePlayerFeeAmount) public {
        ...
        // Update the create player fee amount
        player.setCreatePlayerFeeAmount(newCreatePlayerFeeAmount);
        console2.log(
            "Player contract at", playerContractAddr, "updated create player fee amount to:", newCreatePlayerFeeAmount
        );
