...
contract UpdateEquipmentRequirementsScript is Script {
    ...
    function run(address newEquipmentRequirementsAddr, address payable playerContractAddr) public {
        ...
        // Update the EquipmentRequirements
        player.setEquipmentRequirements(newEquipmentRequirementsAddr);
        console2.log(
            "Player contract at",
            playerContractAddr,
            "updated to use EquipmentRequirements at:",
            newEquipmentRequirementsAddr
        );
