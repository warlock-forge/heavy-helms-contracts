...
- **Maximum Level**: 10
- **XP per level**: 100 (L2), 150 (L3), 225 (L4), 338 (L5), 506 (L6), 759 (L7), 1139 (L8), 1709 (L9), 2563 (L10)
- **Cumulative XP**: 100 (L2), 250 (L3), 475 (L4), 813 (L5), 1319 (L6), 2078 (L7), 3217 (L8), 4926 (L9), 7489 (L10)
