...
The GameEngine.sol contract (version 25) handles all combat calculations and battle resolution. It uses deterministic calculations based on fighter attributes, equipment, and stances to process turn-based combat with stamina management.
...
- **ID 0 - Arming Sword + Kite**: 54-69 dmg, 75 spd, 140 parry, 100 riposte, 175 crit, 100 stam, Slash
- **ID 1 - Mace + Tower**: 38-52 dmg, 70 spd, 140 parry, 85 riposte, 220 crit, 105 stam, Blunt
- **ID 2 - Rapier + Buckler**: 35-55 dmg, 90 spd, 280 parry, 250 riposte, 190 crit, 85 stam, Pierce, +15 dodge
- **ID 7 - Shortsword + Buckler**: 32-48 dmg, 90 spd, 300 parry, 260 riposte, 160 crit, 80 stam, Slash, +15 dodge
- **ID 8 - Shortsword + Tower**: 34-46 dmg, 85 spd, 120 parry, 80 riposte, 120 crit, 100 stam, Slash
- **ID 11 - Scimitar + Buckler**: 42-62 dmg, 85 spd, 260 parry, 240 riposte, 180 crit, 85 stam, Slash, +15 dodge
- **ID 12 - Axe + Kite**: 50-67 dmg, 70 spd, 120 parry, 85 riposte, 200 crit, 115 stam, Slash
- **ID 13 - Axe + Tower**: 36-50 dmg, 65 spd, 120 parry, 65 riposte, 270 crit, 125 stam, Slash
- **ID 15 - Flail + Buckler**: 45-65 dmg, 70 spd, 260 parry, 220 riposte, 225 crit, 95 stam, Blunt
- **ID 16 - Mace + Kite**: 55-70 dmg, 65 spd, 160 parry, 100 riposte, 200 crit, 105 stam, Blunt
- **ID 17 - Club + Tower**: 35-49 dmg, 70 spd, 75 parry, 65 riposte, 230 crit, 85 stam, Blunt

**Two-Handed Weapons**:
- **ID 3 - Greatsword**: 130-175 dmg, 60 spd, 120 parry, 70 riposte, 220 crit, 200 stam, Slash
- **ID 4 - Battleaxe**: 130-195 dmg, 40 spd, 70 parry, 40 riposte, 270 crit, 300 stam, Slash
- **ID 5 - Quarterstaff**: 55-77 dmg, 80 spd, 140 parry, 120 riposte, 160 crit, 110 stam, Blunt, +15 dodge
- **ID 6 - Spear**: 72-96 dmg, 80 spd, 130 parry, 140 riposte, 145 crit, 160 stam, Pierce, +15 dodge
- **ID 25 - Maul**: 140-205 dmg, 40 spd, 70 parry, 40 riposte, 320 crit, 320 stam, Blunt
- **ID 26 - Trident**: 100-150 dmg, 55 spd, 100 parry, 100 riposte, 220 crit, 240 stam, Pierce

**Dual-Wield Weapons**:
- **ID 9 - Dual Daggers**: 40-60 dmg, 115 spd, 70 parry, 70 riposte, 130 crit, 75 stam, Pierce, +15 dodge
- **ID 10 - Rapier + Dagger**: 38-73 dmg, 100 spd, 140 parry, 300 riposte, 120 crit, 100 stam, Pierce, +10 dodge
- **ID 14 - Dual Scimitars**: 52-76 dmg, 100 spd, 80 parry, 80 riposte, 135 crit, 165 stam, Slash, +10 dodge
- **ID 18 - Dual Clubs**: 60-83 dmg, 85 spd, 50 parry, 50 riposte, 180 crit, 120 stam, Blunt, +5 dodge

**Hybrid Damage Dual-Wield**:
- **ID 19 - Arming Sword + Shortsword**: 63-80 dmg, 85 spd, 130 parry, 150 riposte, 180 crit, 130 stam, Slash
- **ID 20 - Scimitar + Dagger**: 54-74 dmg, 105 spd, 140 parry, 300 riposte, 150 crit, 90 stam, Hybrid Slash/Pierce
- **ID 21 - Arming Sword + Club**: 75-95 dmg, 75 spd, 90 parry, 65 riposte, 240 crit, 115 stam, Hybrid Slash/Blunt
- **ID 22 - Axe + Mace**: 67-93 dmg, 65 spd, 75 parry, 70 riposte, 280 crit, 120 stam, Hybrid Slash/Blunt
- **ID 23 - Flail + Dagger**: 62-90 dmg, 70 spd, 200 parry, 140 riposte, 200 crit, 125 stam, Hybrid Pierce/Blunt
- **ID 24 - Mace + Shortsword**: 55-75 dmg, 70 spd, 160 parry, 85 riposte, 225 crit, 110 stam, Hybrid Slash/Blunt
...
#### The 80% Hit Chance "Cap" Issue
**CLARIFICATION NEEDED**: User mentioned an 80% hit chance cap that needs fixing, but code shows 95% cap. This discrepancy needs investigation.

#### Stat Scaling Problems
From balance testing analysis:

1. **SIZE dominates STRENGTH** for damage dealers:
   - SIZE affects: damage + health + block + crit multiplier  
   - STR affects: damage + crit multiplier only
   - SIZE provides 4 benefits vs STR's 2 benefits

2. **Equipment matchups dominate stats**:
   - Good equipment + bad stats: ~75% win rate
   - Great stats + bad equipment: ~51% win rate
   - Equipment choice more important than stat optimization

3. **Progression too weak**:
   - Level 10 vs Level 1 (1 point/level): only ~58% win rate
   - Should be 80%+ win rate for meaningful progression
   - Current system makes random builds competitive with optimized builds

#### Potential Solutions Under Consideration
- Increase attribute point gain per level (2-3 points instead of 1)
- Rebalance stat formulas to make stats more impactful
- Adjust weapon/armor balance to reduce equipment dominance
- Investigate and fix the hit chance cap issue
...
- **Dual Daggers** (40-60 base) with AGI 25 gets: `60 * (25 + (8+8)*5)/100 = 60 * 105/100 = 63 damage`
- **Battleaxe** (130-195 base) with STR/SIZE 25 gets: `195 * (25 + (25+25)*5)/100 = 195 * 275/100 = 536 damage`

**Result**: The AGI assassin does 63 damage, the STR berserker does 536 damage. AGI is **COMPLETELY WORTHLESS** for damage because:
1. AGI doesn't affect `damageModifier` at all
2. Only STR+SIZE affects `damageModifier`
3. Weapon base damage difference (40-60 vs 130-195) is tiny compared to modifier difference
...
### Future Architecture: Weapon/Armor Classifications (REQUIRES ARCHITECTURE FIX FIRST)
